...
<head>
  <meta charset="UTF-8">
  <title>Login LogTransSawit</title>
...
<div class="form">
  ...
  <?php echo e(csrf_field()); ?>
    ...
    <button>login</button>
    <p class="message"><a href="<?php echo e(route('home')); ?>">Beranda</a> | <a href="<?php echo e(route('login.lupapassword')); ?>">Lupa Password?</a> | <a href="<?php echo e(route('login.register')); ?>">Buat Akun</a></p>
  </form>
</div>
