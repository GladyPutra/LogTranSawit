                        ...
                        <tbody>
                          <?php $__currentLoopData = \App\Kapasitas::where('tgl',date('Y-m-d'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              ...
                              <td><?php echo e(number_format( $kp->kapasitas, 0 , '.' , ',' )); ?></td>
                              <td>
                                <button data-toggle='modal' data-target='#modaledit' class="btn btn-sm btn-primary" onclick="clickedit(this)" data-shift="<?php echo e($kp->shift); ?>" value="<?php echo e($kp->id); ?>"><i class="fa fa-edit"></i> Ubah</button>
                                <button class="btn btn-sm btn-danger" onclick="deletekapasitas(this,event)" value="<?php echo e($kp->id); ?>">Hapus</button>
