    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                <div class="col-sm-4 col-xs-8 form-group">
                    ...
                    <a href="<?php echo e(route('pegawai.tampil')); ?>" class="btn btn-success"><i class="fa fa-refresh"></i> Segarkan</a>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php if(isset($dataUser)): ?>
                                 <td><input id="txtuseredit" value="<?php echo e($dataUser->username); ?>" type="text" class="form-control" name="username" placeholder="Masukkan Nama Pengguna"/>
                     ...
                     <table>
                            ...
                            <?php else: ?>
                                <td>&emsp;<button class="btn btn-primary btnsimpan" value="<?php echo e(route('pegawai.simpan')); ?>" ><i class="fa fa-save fa-fw"></i>Simpan</button></td>
                            <?php endif; ?>
