<table class="table table-striped table-bordered">
    ...
    <?php $i2 = 2; ?>
    <?php $__currentLoopData = \App\Blok::where('id_afdeling',$afdeling->id_afdeling)->where('id_blok','<>',\App\Blok::min('id_blok'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
