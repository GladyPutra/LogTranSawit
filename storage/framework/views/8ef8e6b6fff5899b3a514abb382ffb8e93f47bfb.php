		...
		<?php foreach(\App\Krani::where('id_user',\Auth::user()->id_user)->get() as $blok): ?>
			...
			google.maps.event.addListener(shape, 'click', function(e) {
				...
				infowindow.setContent(
					...
					"</tr>"+
					"<tr>"+
					"<td>Jumlah Pohon</td><td>:</td><td><?php echo e(number_format( \App\Blok::where('id_blok',$blok->id_blok)->pluck('jumlah_pohon')->first(), 0 , '.' , ',' )); ?></td>"+
					"</tr>"+
					"<tr>"+
					"<td>Luas Blok</td>"+
					"<td>:</td><td>"+IO.OUT_luas((JSON.parse(<?php echo json_encode(\App\Blok::where('id_blok',$blok->id_blok)->pluck('koordinat')->first())?>)),map,"")+"</td></tr>"+
					"<td>Jumlah Panen</td>"+
					"<td>:</td><td><?php echo e(number_format( \App\Taksasi::where('id_blok',\App\Blok::where('id_blok',$blok->id_blok)->pluck('id_blok')->first())->pluck('panen')->first(), 0 , '.' , ',' )); ?> Buah</td></tr>"+
					"</table>"+
					"<td></td>"+
				...
				infowindow.setContent(
					...
					"</table>"+
					"<td></td>"+
					"<td>:</td><td><button class='btn btn-sm btn-primary inputtaksasi' data-idafdeling='<?php echo e($blok->id_afdeling); ?>' data-idblok='<?php echo e($blok->id_blok); ?>' data-toggle='modal' data-target='#modaltaksasi'>Tambah Panen</button></td></tr>"+
					"</table>");
				<?php endif;?>
