						...
						<form method="post" action="">
							...
							<label>Pilih Sopir</label>
									...
									<option value="0">--Pilih Sopir--</option>
										<?php $__currentLoopData = \App\User::where('id_role',App\Role::max('id_role'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $af): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($af->id_user); ?>"><?php echo e($af->username); ?></option>
...
function initMap() {
	...
	function draws()
	{
		var crd;
		$.ajax({
			url: '<?php echo e(route("refreshcoordhistori")); ?>',
			type: 'get',
