  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Input Panen: </h4>
				<h5 class="detailafdeling"></h5>
      </div>
			<form method="post" action="<?php echo e(route('tambahpanen')); ?>">
	      ...
	      <div class="modal-body">
					<div class="col-md-12 form-group">
						<label>Panen</label>
						<input type="text" class="form-control" name="panen"/>
					</div>
		...
		<?php foreach(\App\Krani::where('id_user',\Auth::user()->id_user)->get() as $blok): ?>
			...
			google.maps.event.addListener(shape, 'click', function(e) {
				...
				infowindow.setContent(
					...
					"<table class='table'>"+
					"<tr>"+
					"<td>Nama Krani</td><td>:</td><td><?php echo e(\App\User::where('id_user',$blok->id_user)->pluck('nama')->first()); ?></td>"+
					"</tr>"+
					"<tr>"+
					"<td>ID Afdeling</td><td>:</td><td><?php echo e(\App\Blok::where('id_blok',$blok->id_blok)->pluck('id_afdeling')->first()); ?></td>"+
					"</tr>"+
					"<tr>"+
					"<td>ID Blok</td><td>:</td><td><?php echo e($blok->id_blok); ?></td>"+
					"</tr>"+
					"<tr>"+
					"<td>Deskripsi</td><td>:</td><td><?php echo e(\App\Blok::where('id_blok',$blok->id_blok)->pluck('deskripsi')->first()); ?></td>"+
					"</tr>"+
					"<tr>"+
					"<td>Jumlah Pohon</td><td>:</td><td><?php echo e(\App\Blok::where('id_blok',$blok->id_blok)->pluck('jumlah_pohon')->first()); ?></td>"+
					"</tr>"+
					"<tr>"+
					"<td>Luas Blok</td>"+
					"<td>:</td><td>"+IO.OUT_luas((JSON.parse(<?php echo json_encode(\App\Blok::where('id_blok',$blok->id_blok)->pluck('koordinat')->first())?>)),map,"")+"</td></tr>"+
					"<td>Jumlah Panen</td>"+
					"<td>:</td><td><?php echo e(\App\Taksasi::where('id_blok',\App\Blok::where('id_blok',$blok->id_blok)->pluck('id_blok')->first())->pluck('panen')->first()); ?> buah</td></tr>"+
					"</table>"+
					"<td></td>"+
				...
				infowindow.setContent(
					...
					"</table>"+
					"<td></td>"+
					"<td>:</td><td><button class='btn btn-sm btn-primary inputtaksasi' data-idafdeling='<?php echo e($blok->id_afdeling); ?>' data-idblok='<?php echo e($blok->id_blok); ?>' data-toggle='modal' data-target='#modaltaksasi'>Input Panen</button></td></tr>"+
					"</table>");
				<?php endif;?>
