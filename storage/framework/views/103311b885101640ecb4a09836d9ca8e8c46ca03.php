                ...
                <form class="form_isi" action="" method="post" role="form">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php else: ?>
                                <td><input id="txtusersimpan" value="" type="text" class="form-control" name="username" placeholder="Masukkan Nama "></td>
                            <?php endif; ?>
                        </tr>
                        <tr>
                            <td width="200px">PASSWORD</td>
                            <td><input type="password"class="form-control" name="password" placeholder="Masukkan Nama Lengkap" 
