...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="panel panel-default">
			...
			<div class="row">
				<div class="col-md-3 col-md-offset-9" style="padding: 10px 10px 10px 10px;text-align:center; margin-bottom:10px;color:black;background:rgba(194, 214, 214,0.3);"><strong>Tanggal : <?php echo e(date("l") . date('d/m/Y')); ?></strong></div>
			</div>
			<br/>
			<div class="row">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title title-a"></h4>
			...
			<form id="formangkut" method="post" action="<?php echo e(route('angkutpanen')); ?>">
        ...
        <?php if($blok->hari_panen == $hari): ?>
  				...
  				google.maps.event.addListener(shape, 'click', function(e) {
						$("#modalangkut").on('show.bs.modal',function(){
							$(".title-a").text('<?php echo e($blok->deskripsi); ?>');
							$(".content-mdl").html(
								<?php foreach(\App\TPH::where('id_blok',$blok->id_blok)->get() as $tph): ?>
								'<div class="row">'+
									'<div class="col-md-3 form-group">'+
										'<h3><?php echo e($tph->deskripsi); ?> : </h3>'+
									'</div>'+
									'<div class="col-md-4 form-group">'+
										'<label>Angkut</label>'+
										'<input type="number" name="angkut[]" class="form-control"/>'+
										'<input type="hidden" name="temp_id[]" class="form-control" value="<?php echo e($tph->id_tph); ?>"/>'+
										'<input type="hidden" name="id_blok[]" class="form-control" value="<?php echo e($blok->id_blok); ?>"/>'+
									'</div>'+
									'<div class="col-md-4 form-group">'+
										'<label>Sisa</label>'+
