...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="panel panel-default">
			...
			<div class="row">
				<div class="col-md-3 col-md-offset-4" style="padding: 10px 10px 10px 10px;text-align:center; margin-bottom:10px;color:black;background:rgba(194, 214, 214,0.3);"><strong>Tanggal Taksasi : <?php echo e(date('d/m/Y',strtotime(\App\Taksasi::where('id_taksasi',\App\Taksasi::max('id_taksasi'))->pluck('tgl_taksasi')->first()))); ?></strong></div>
			</div>
			<div class="row">
				...
				<div class="card" style="width: 18rem;">
					<div class="card-body">
						<table style="margin-top:12px" class="table table-bordered">
							...
							<tbody>
								<tr>
									<td style="text-align:center"><h3><strong><?php echo e($tahunanbuah); ?></strong></h3> buah</td>
									<td style="text-align:center"><h3><strong><?php echo e($tahunanberat); ?></strong></h3> Kg</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="card" style="width: 18rem;">
					<div class="card-body">
						<table style="margin-top:12px" class="table table-bordered">
							...
							<tbody>
								<tr>
									<td style="text-align:center"><h3><strong><?php echo e($bulananbuah); ?></strong></h3> buah</td>
									<td style="text-align:center"><h3><strong><?php echo e($bulananberat); ?></strong></h3> Kg</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="card" style="width: 18rem;">
					<div class="card-body">
						<table style="margin-top:12px" class="table table-bordered">
							...
							<tbody>
								<tr>
									<td style="text-align:center"><h3><strong><?php echo e($mingguanbuah); ?></strong></h3> buah</td>
									<td style="text-align:center"><h3><strong><?php echo e($mingguanberat); ?></strong></h3> Kg</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="card" style="width: 18rem;">
					<div class="card-body">
						<table style="margin-top:12px" class="table table-bordered">
							...
							<tbody>
								<tr>
									<td style="text-align:center"><h3><strong><?php echo e($harianbuah); ?></strong></h3> buah</td>
									<td style="text-align:center"><h3><strong><?php echo e($harianberat); ?></strong></h3> Kg</td>
								</tr>
							</tbody>
						</table>
					</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Input Taksasi: </h4>
	      ...
	      <div class="modal-body">
					...
					<div class="col-md-12 form-group">
						<label>Harian</label>
						<input type="text" class="form-control" name="harian"/>
					</div>
					<div class="col-md-12 form-group">
						<label>Mingguan</label>
						<input type="text" class="form-control" name="mingguan"/>
					</div>
					<div class="col-md-12 form-group">
						<label>Bulanan</label>
						<input type="text" class="form-control" name="bulanan"/>
					</div>
					<div class="col-md-12 form-group">
						<label>Tahunan</label>
						<input type="text" class="form-control" name="tahunan"/>
					</div>
					<div class="col-md-12 form-group">
						<label>Berat Rata-Rata(Kg)</label>
						<input type="text" class="form-control" name="rata"/>
					</div>
			...
			<?php if($afd->id_user == \Auth::user()->id_user):?>
				...
				google.maps.event.addListener(shapeafd, 'click', function(e) {
					...
					infowindow.setContent(
						...
						"</tr>"+
						"<tr>"+
						"<td>Jumlah Pohon</td><td>:</td><td><?php echo e($afd->jumlah_pohon); ?></td>"+
						"</tr>"+
						"<tr>"+
						"<td>Luas Afdeling</td>"+
			...
			<?php if(\App\Afdeling::where('id_afdeling',$blok->id_afdeling)->pluck('id_user')->first() == \Auth::user()->id_user):?>
				...
				google.maps.event.addListener(shape, 'click', function(e) {
					...
					infowindow.setContent(
						...
						"</tr>"+
						"<tr>"+
						"<td>Jumlah Pohon</td><td>:</td><td><?php echo e($blok->jumlah_pohon); ?></td>"+
						"</tr>"+
						"<tr>"+
						"<td>Luas Blok</td>"+
						...
						"<tr>"+
						"<td>Jumlah Panen</td>"+
						"<td>:</td><td><?php echo e(\App\Taksasi::where('id_blok',$blok->id_blok)->pluck('panen')->first()); ?></td></tr>"+
						"</table>"+
						"<td></td>"+
						"<td>:</td><td><button class='btn btn-sm btn-primary inputtaksasi' data-idafdeling='<?php echo e($blok->id_afdeling); ?>' data-idblok='<?php echo e($blok->id_blok); ?>' data-toggle='modal' data-target='#modaltaksasi'>Input Taksasi</button></td></tr>"+
						"</table>");
					infowindow.open(map);
				});
			<?php endif; ?>
