...
<head>
  ...
  <link rel="icon" href="{{ asset('logoa.png') }}"/>
  ...
  html
  {
    background:url('{{ asset("kebun.jpg") }}') no-repeat center center fixed;
...
<div class="form">
  <div ><img src="{{asset('/logo.jpg')}}" alt="" height="200px" width="200px"/></div>
  ...
  {{ csrf_field() }}
    ...
    <button>Masuk</button>
    <p class="message"><a href="{{ route('home') }}">Beranda</a> | <a href="{{ route('login.lupapassword') }}">Lupa Kata Sandi?</a> | <a href="{{ route('login.register') }}">Buat Akun</a></p>
  </form>
</div>
