	...
	<div class="col-lg-12">
        ...
        <!-- Tambah Blok -->
				...
				<div class="menutbhblok" style="display:none">
					<div class="row">
						...
						<div class="col-md-12 form-group">
							<a class="btn btn-sm btn-danger" id="clear_shapes2">Clear Shape</a>
							<button class="btn btn-sm btn-success" id="btnsimpanblok">Simpan</button>
							<br/>
        ...
        <div class="menutbhtph" style="display:none">
          <div class="row">
            ...
            <div class="col-md-12 form-group">
              <a class="btn btn-sm btn-danger" id="clear_shapes3">Clear Shape</a>
              <button class="btn btn-sm btn-success" id="btnsimpantph">Simpan</button>
              <br/>
              <hr style="color:black;width100%"/>
            </div>
            </form>
